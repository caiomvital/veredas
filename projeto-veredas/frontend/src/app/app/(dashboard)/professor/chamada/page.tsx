...
export default function ChamadaPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[var(--color-primary-800)]">Chamada / Frequência</h1>
        <p className="text-sm text-gray-500 mt-1">Selecione a turma para lançar frequência.</p>
      </div>
      {error && (
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {turmas.map((t) => (
          <Link key={t.id} href={`/professor/chamada/${t.id}`}>
