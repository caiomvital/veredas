    ...
    <div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 mb-8">
        <CardLink
          ...
          href="/app/professor/registro-aulas"
          cor="bg-blue-500"
          isLoading={isLoading}
        />
        <CardLink
...
const acoes = [
  { label: 'Chamada', href: '/app/professor/chamada', icon: <ClipboardList size={16} />, cor: 'bg-orange-500' },
  { label: 'Lançar Notas', href: '/app/professor/notas', icon: <BarChart3 size={16} />, cor: 'bg-green-500' },
  { label: 'Boletins', href: '/app/professor/boletins', icon: <BarChart3 size={16} />, cor: 'bg-purple-500' },
  { label: 'Reg. Aulas', href: '/app/professor/registro-aulas', icon: <Notebook size={16} />, cor: 'bg-blue-500' },
  { label: 'Planejamento', href: '/app/professor/planejamento', icon: <BookOpen size={16} />, cor: 'bg-indigo-500' },
  { label: 'Atividades', href: '/app/professor/atividades', icon: <ClipboardList size={16} />, cor: 'bg-amber-500' },
]
