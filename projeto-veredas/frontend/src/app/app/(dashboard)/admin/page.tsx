...
const CARDS: CardData[] = [
  { label: 'Alunos', href: '/app/admin/alunos', icon: Users, countKey: 'alunos', color: 'bg-blue-500' },
  { label: 'Turmas', href: '/app/admin/turmas', icon: BookOpen, countKey: 'turmas', color: 'bg-green-500' },
  { label: 'Funcionários', href: '/app/admin/funcionarios', icon: GraduationCap, countKey: 'funcionarios', color: 'bg-purple-500' },
  { label: 'Matrículas', href: '/app/secretaria/matriculas', icon: FileText, countKey: 'matriculas', color: 'bg-red-500' },
  { label: 'Financeiro', href: '/app/admin/financeiro', icon: DollarSign, countKey: 'matriculas', color: 'bg-yellow-500' },
  { label: 'Comunicados', href: '/app/comunicados', icon: Bell, countKey: 'comunicadosNaoLidos', color: 'bg-indigo-500' },
]
  ...
  return (
    <div>
      ...
      {aniversariantesHoje > 0 && (
        <Link href="/app/admin/aniversariantes">
