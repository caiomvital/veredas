    ...
    <div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Carda
          ...
          href="/app/secretaria/matriculas"
          cor="bg-green-500"
          isLoading={isLoading}
        />
        <Carda
        ...
        <Carda
          ...
          href="/app/secretaria/avisos-whatsapp"
          cor="bg-emerald-500"
          isLoading={isLoading}
        />
      </div>
...
const acoes = [
  { label: 'Nova Matrícula', href: '/app/secretaria/matriculas/nova', icon: <ClipboardList size={18} />, cor: 'bg-blue-500' },
  { label: 'Declarações', href: '/app/secretaria/declaracoes', icon: <Users size={18} />, cor: 'bg-green-500' },
  { label: 'Histórico Escolar', href: '/app/secretaria/historico', icon: <Users size={18} />, cor: 'bg-purple-500' },
  { label: 'Transferência', href: '/app/secretaria/transferencia', icon: <Users size={18} />, cor: 'bg-orange-500' },
  { label: 'Avisos WhatsApp', href: '/app/secretaria/avisos-whatsapp', icon: <MessageCircle size={18} />, cor: 'bg-emerald-500' },
]
